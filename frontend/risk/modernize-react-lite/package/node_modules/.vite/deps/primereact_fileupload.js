...
} from "./chunk-XNWP2VIU.js";
import {
  require_react_dom
} from "./chunk-NUEOKNEP.js";
import "./chunk-POOCAO6G.js";
import "./chunk-K3OSWSQU.js";
import {
  require_react
...
var DomHandler = function() {
  ...
  return _createClass(DomHandler2, null, [{
    ...
    value: function setAttributes(element) {
      ...
      if (element) {
        var _computedStyles = function computedStyles(rule, value2) {
        ...
        Object.entries(attributes).forEach(function(_ref5) {
          ...
          if (value2 !== void 0 && value2 !== null) {
            ...
            if (matchedEvent) {
              ...
              value2 = key === "class" ? _toConsumableArray(new Set(_computedStyles("class", value2))).join(" ").trim() : key === "style" ? _computedStyles("style", value2).join(";").trim() : value2;
  ...
  extend: function extend() {
    ...
    var getPTValue = function getPTValue2() {
      ...
      var getPTClassValue = function getPTClassValue2() {
        var value2 = _getOptionValue.apply(void 0, arguments);
...
var getDefaultPT = function getDefaultPT2() {
  return _getPT(ComponentBase.context.pt || PrimeReact2.pt, void 0, function(value2) {
    return _getOptionValue(value2, ComponentBase.cName, ComponentBase.cParams) || ObjectUtils.getItemValue(value2, ComponentBase.cParams);
  });
};
...
var InfoCircleIcon = React15.memo(React15.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React15.createElement("svg", _extends11({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var TimesCircleIcon = React16.memo(React16.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React16.createElement("svg", _extends12({
    ref,
    width: "14",
    height: "14",
    viewBox: "0 0 14 14",
...
var Messages = React17.memo(React17.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React17.useState([]), _React$useState2 = _slicedToArray6(_React$useState, 2), messagesState = _React$useState2[0], setMessagesState = _React$useState2[1];
  ...
  return React17.createElement("div", _extends13({
    ref: elementRef
    ...
    return React17.createElement(CSSTransition, _extends13({
      nodeRef: messageRef,
      key: message._pId
...
var ProgressBar = React18.memo(React18.forwardRef(function(inProps, ref) {
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React18.createElement("div", _extends14({
      id: props.id,
      ref: elementRef
...
function _slicedToArray7(r, e) {
  return _arrayWithHoles7(r) || _iterableToArrayLimit7(r, e) || _unsupportedIterableToArray$12(r, e) || _nonIterableRest7();
}
var classes$12 = {
...
var FileUpload = React19.memo(React19.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React19.useState([]), _React$useState2 = _slicedToArray7(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React19.useState([]), _React$useState4 = _slicedToArray7(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React19.useState(0), _React$useState6 = _slicedToArray7(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  var _React$useState7 = React19.useState(false), _React$useState8 = _slicedToArray7(_React$useState7, 2), focusedState = _React$useState8[0], setFocusedState = _React$useState8[1];
  var _React$useState9 = React19.useState(false), _React$useState10 = _slicedToArray7(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  var metaData = {
    props,
    state: {
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React19.createElement("span", _extends15({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React19.createElement("img", _extends15({}, thumbnailProps, {
      alt: file.name
    })) : null;
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React19.createElement(UploadIcon, uploadIconProps), _objectSpread9({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React19.createElement(TimesIcon, cancelIconProps), _objectSpread9({}, cancelIconProps), {
        props
      });
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React19.createElement("span", _extends15({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React19.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React19.createElement("span", labelProps, hasFiles ? filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps2({
      className: cx("chooseIcon", {
